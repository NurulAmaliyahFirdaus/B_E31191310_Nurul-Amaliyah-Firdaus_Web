<?php 
	...
	echo "Nama : ".$person -> nama="Nurul Amaliyah Firdaus";
	echo "<br>";
	echo "Asal : ".$person -> asal="Kabupaten Pasuruan";
	echo "<br>";
	echo "Nilai Matematika :" .$person -> matematika="89";
	echo "<br>";
	echo "Nilai Fisika :" .$person -> fisika="85";
	echo "<br>";
	echo "Nilai Kimia : " .$person -> kimia="87";
	echo "<br>";
	echo "Nilai Bhs. Inggris : " .$person -> inggris="85";
	echo "<br>";
